/* Roadora PWA service worker v6.8.2 */
'use strict';
...
const APP_SHELL = [
  ...
  '/css/webplanner.css?v=6.8.2',
  '/css/styles.css',
  '/js/leaflet-fallback.js?v=6.8.2',
  '/js/trip-db.js?v=6.8.2',
  '/js/webplanner.js?v=6.8.2',
  '/js/app-shell.js?v=6.8.2',
  '/js/pwa.js?v=6.8.2',
  '/js/main.js',
